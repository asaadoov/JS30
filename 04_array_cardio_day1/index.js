...
/* 4 */
const reducedInventors = inventors.reduce((total, curr) => {
...
/* 5 */
const sortedByYears = inventors.sort((a, b) => (a.passed - a.year) - (b.passed - b.year));
...
const transport = data.reduce((obj, element) => {
    element in obj ? obj[element]++ : obj[element] = 0;
    return obj;
}, {});
